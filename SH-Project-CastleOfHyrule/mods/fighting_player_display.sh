...
echo -e "\n============================================= ${BOLD}FIGHT "$fightNb"${NC} ========================================"
echo -e "\n\n"
printf "${RED}${BOLD}$enemieName${NC} \n"
echo -e "\n"
printf "${NC}${BOLD}HP: ${NC}"

count=0

while [[ "$count" -lt "$enemieNormalHp" ]]
do
	if [ "$count" -lt "$enemieHp" ]
	then
		printf "${RED}${BOLD}I${NC}"
	else
		printf " "
	fi
	count=$(($count+1))
...
echo -e "\n\n"
printf "${GREEN}${BOLD}$playerName${NC}\n"
echo -e "\n"
printf "${NC}${BOLD}HP: ${NC}"

count=0

while [ "$count" -lt "$playerNormalHp" ]
do
        if [ "$count" -lt "$playerHp" ]
        then
                printf "${BOLD}I${NC}"
        else
                printf " "

...
pickRarity() {
	...
	if [ $chosenRarity -le 50 ]
	then
	        chosenRarity=1
	else
	        if [ $chosenRarity -le 80 ]
	        then
	                chosenRarity=2
	        else
	                if [ $chosenRarity -le 95 ]
	                then
	                        chosenRarity=3
	                else
	                        if [ $chosenRarity -le 99 ]
	                        then
	                                chosenRarity=4
	                        else
	                                if [ $chosenRarity -le 100 ]
	                                then
	                                        chosenRarity=5
	                                fi
	                        fi
...
do
	...
	do
		if [ $first_line -ne 0 ]
		then
			if [ "$rarity" = "$tempRarity" ] && [ "$chosenEnemieId" = "$countEnemiesRarity" ]
			then
...
do
	if [ $first_line -ne 0 ]
        then
                if [ "$rarity" = "$tempRarity" ] && [ "$chosenBossId" = "$countBossesRarity" ]
                then
